    ...
    def _get_answer(self, record, body, values, command=False):
        ...
        if self._is_bot_in_private_channel(record):
            ...
            if odoobot_state == 'onboarding_emoji' and self._body_contains_emoji(body):
                ...
                return _("Yep, I am here! 🎉 <br/>You finished the tour, you can <b>close this chat window</b>. Enjoy discovering Hive.")
            ...
            # easter eggs
                ...
                return _("I'm just a bot... :Contact Geopro Global Solutions for more information!")
                ...
                if odoobot_state == 'onboarding_emoji':
                    ...
                    return _("Sorry, I am not listening. To get someone's attention, <b>ping him</b>. Write \"@bot\" and select me.")
            ...
            return random.choice([_("Yep, Bot is in the place!"), _("Pong.")])
        return False
